...
$().ready(function(){
			...
			if(money1==""){
			 ...
			 $.ajax({
			       ...
			       success: function(data) {
			    	   ...
			    	   if(suc=="false"){
			    		   alert("转账失败,请确认收款人姓名与账户");
			    	   }else if(suc=="moneyFalse"){
			    		   alert("余额不足，请更换支付方式");
			    	   } else{
			    		   alert("转账成功,感谢您的使用")
			    		   window.location.href="zz.do";
			    	   }
			       }
			   })
		}
	...
	function checkPWD(){
		var isPWD= document.getElementById('fk').value;
		if(isPWD!=1){
			$("#passDIV").show();
		}
		if(isPWD == 1){
		...
		<nav class='' id='main-nav'>
			<div class='navigation'>
				...
				<ul class='nav nav-stacked'>
					...
					<li class='active'><a href='zz?name=${name }'> <i
						...
						<div class='row-fluid'>
							<div class='span12'>
								<div class='page-header'>
									<h1 class='pull-left'>
										<i class='icon-mail-reply'></i> <span>在线转账</span>
									</h1>
							...
							<div class='row-fluid'>
								<div class='span12 box'>
									...
									<div class='box-content form form-horizontal validate-form'>
											...
											<label class='control-label' for='validation_name'>收款人姓名:</label>
											<div class='controls'>
										
												<input data-rule-minlength='2' data-rule-required='true' style='width:400px;height:35px'
													id='names' name='names' placeholder='请输入收款人姓名' type='text' 
													
													/>
											</div>
											</div>
											<div class='control-group'>
											<label class='control-label' for='validation_name' >收款人账号:</label>
											<div class='controls'>
										
												<input data-rule-minlength='2' data-rule-required='true' style='width:400px;height:35px'
													id='t3' name='t3' placeholder='请输入收款人账号' type='text' 
										...
										<div class='control-group'>
											...
											<div class='controls'>
												<input data-rule-minlength='2' data-rule-required='true' style='width:400px;height:35px'
													id='money1' name='money1' placeholder='请输入您的需要充值的金额' type='text' 
										...
										<div class='control-group'>
											<label class='control-label' for='validation_name'>请选择支付方式</label>
											<div class='controls'>
												<select class="form-control" name="fk" id="fk" onclick="checkPWD()">
													
													<option  name="fk" value="1" selected="selected">网上余额</option>
										...
										<div class='control-group' id='passDIV' style="display:none">
											<label class='control-label' for='validation_name'>请输入密码</label>
											<div class='controls'>
											<input  class="cardPWD" type="password"  data-rule-minlength='2' data-rule-required='true' style='width:400px;height:35px;'  />
											</div>
										</div>
										<div class='control-group'>
										...
										<div class='form-actions' style='margin-bottom: 0'>
											<button class='btn-primary' type='submit' onclick="validate()">
												<i class='' >提交</i> 
											</button>
										</div>
