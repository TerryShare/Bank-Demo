			...
			<div class="main-right  col-md-10 col-md-offset-2">
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<form action="seachCard">
                                <div class="input-group">
                                    <input id="owner" name="owner" type="text" class="form-control" placeholder="Search for..." />
