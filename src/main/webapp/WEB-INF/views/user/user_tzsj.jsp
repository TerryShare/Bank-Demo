			 ...
			 $.ajax({
			       ...
			       success: function(data) {
			    	   ...
			    	   if(suc=="false"){
			    		   ...
			    		   alert("充值成功,感谢您的使用")
			    		   window.location.href="sj.do?${name}";
			    	   }
			       }
			   })
		}
					...
					<ul class='nav pull-right'>
						...
						<li class='dropdown dark user-menu'><a
							class='dropdown-toggle' data-toggle='dropdown' href='#'> <span
								class='user-name hidden-phone'>${name }</span> <b class='caret'></b>
						</a>
							<ul class='dropdown-menu'>
								<li><a href='exit'> <i class='icon-signout'></i> 退出系统
								</a></li>
							</ul></li>
					</ul>
		...
		<nav class='' id='main-nav'>
			<div class='navigation'>
				...
				<ul class='nav nav-stacked'>
					...
					<li class='active'><a href='sj?name=${name }'> <i
						...
						<div class='row-fluid'>
							<div class='span12'>
								<div class='page-header'>
									<h1 class='pull-left'>
										<i class='icon-mail-reply'></i> <span>手机缴费</span>
									</h1>
								...
								<div class='span12 box'>
									...
									<div class='box-content  form form-horizontal validate-form'>
										<div class='control-group'>
											...
											<div class='controls'>
												<input data-rule-minlength='2' data-rule-required='true'
													style='width: 400px; height: 35px' id='phone' name='phone'
										...
										<div class='control-group'>
											...
											<div class='controls'>
												<input data-rule-minlength='2' data-rule-required='true'
													style='width: 400px; height: 35px' id='money1'
													name='money1' placeholder='请输入您的需要充值的金额' type='text'
													onkeyup="this.value=(this.value.match(/\d+(\.\d{0,2})?/)||[''])[0]" />
											</div>
										</div>
										<div class='control-group'>
											<label class='control-label' for='validation_name'>请输入付款银行卡</label>
											<div class='controls'>
												<select class="form-control" name="fk" id="fk" onclick="checkPWD()">

													<option  name="fk" id="fk" value="1" selected="selected">网上余额</option>
