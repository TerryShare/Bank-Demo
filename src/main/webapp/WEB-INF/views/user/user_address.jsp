...
<body class='contrast-red ' onload="init()">
	<style type="text/css">
table {
	...
	<div id='wrapper'>
		...
		<nav class='' id='main-nav'>
			...
			<ul class='nav nav-stacked'>
					...
					<li class='active'><a href='cxwd'> <i class='icon-th'></i> <span>网点查询</span>
					</a></li>
						...
						<div class='row-fluid'>
							<div class='span12'>
								<div class='page-header'>
									<h1 class='pull-left'>
										<i class='icon-th'></i> <span>网点查询</span>
									</h1>
						...
						<div class='group-header group-header-first'>
							<div class='row-fluid'>
								<div class='span12 box'>
									 ...
									 <form>  
        所在地区：<select name="province" id="param_province" onchange="provincechange(this.selectedIndex)"><option>请选择省份</option></select>  
        城市：<select name="city" id="param_city"><option>请选择城市</option></select>  
    </form>         
								</div>
